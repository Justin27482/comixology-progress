            ...
            /*< Books or Comics module >*/   
				...
				//		document.getElementsByTagName("head")[0].appendChild(script);
						...
						checkReady(function($) {
							...
							$('<div style="width=100%;"><div style="display:none;float:right;" class="nav_up" id="nav_up"></div><div style="display:none;float:right;" class="nav_down" id="nav_down"></div></div>').insertAfter('#group');
